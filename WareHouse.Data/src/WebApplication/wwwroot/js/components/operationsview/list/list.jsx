            ...
            <div className={classname}>
                <div className="people-list-head">
                    ...
                    <div className="input-group">
                        <input type="text" className="form-control people-list-input" onKeyUp={this.changeSearchText}
                               disabled={!this.props.active} ref={(ref) => this.myTextInput = $(ref)}/>
                        <span className="input-group-btn">
                            <button className="btn btn-default btn-xs" type="button" onClick={this.add}>Add</button>
                        </span>
                    </div>
                </div>
                <ListBody.ListBody values={this.state
